...
import Extinction.duel.modes.DuelModes;
 ...
 * {@code Extinction.duel.modes}; call {@link #duel()} to get it.
 */
public enum MatchMode {
     ...
     * ranked, restores cores, and so on). See {@code Extinction.duel.modes}.
     */
