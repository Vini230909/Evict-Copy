...
- Worker console: `evictattach [port]` — sends the console to that match server; no argument comes back (or lists the running ports when already on the hub). `evictdetach` is a detach-only spelling. See Worker console.
